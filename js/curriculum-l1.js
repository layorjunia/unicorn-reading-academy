...
const LEVEL1 = {
  ...
  islands: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Pip',
      teach: {
        intro: "Hi! I'm Pip the unicorn! Short a says ah, like in cat. Short i says ih, like in sit. Tap each word to hear it!",
        patterns: [
          { g: 'a', say: 'ah', ex: 'cat' },
          { g: 'i', say: 'ih', ex: 'sit' }
        ],
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Dot',
      teach: {
        intro: "I'm Dot the dragon! Short o says aw, like in hop. Short u says uh, like in bug. Short e says eh, like in red.",
        patterns: [
          { g: 'o', say: 'aw', ex: 'hop' },
          { g: 'u', say: 'uh', ex: 'bug' },
          { g: 'e', say: 'eh', ex: 'red' }
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Mimi',
      teach: {
        intro: "Mimi here! Two letters can hold hooves and make ONE sound! S-h says shh. C-h says ch. T-h says th. W-h says wh. C-k says k.",
        patterns: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Pip',
      teach: {
        intro: "Blends are two letters that slide together fast — but you can still hear BOTH sounds! Like s-t in star, and p-l in plum.",
        patterns: [
          { g: 'st', say: 'st', ex: 'star' },
          { g: 'sl', say: 'sl', ex: 'sled' },
          { g: 'fr', say: 'fr', ex: 'frog' },
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Bun',
      teach: {
        intro: "I'm Bun the bunny! Blends can hop onto the END of words too! Like n-d in and, m-p in jump, s-t in nest.",
        patterns: [
          { g: 'nd', say: 'nd', ex: 'sand' },
          { g: 'mp', say: 'mp', ex: 'jump' },
          { g: 'st', say: 'st', ex: 'nest' },
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Dot',
      teach: {
        intro: "Some letters get glued together like sparkle glue! I-n-g says ing like ring. A-n-k says ank like bank. I-n-k says ink like pink. A-l-l says all like ball!",
        patterns: [
