...
const LEVEL2 = {
  ...
  islands: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Pip',
      teach: {
        intro: "Magic e is silent, but it has REAL magic! It jumps to the end and makes the vowel say its NAME. Cap becomes cape! Bit becomes bite!",
        patterns: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Dot',
      teach: {
        intro: "Magic e works on o and u too! Hop becomes hope. Cub becomes cube! The vowel says its name.",
        patterns: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Mimi',
      teach: {
        intro: "When r stands next to a vowel, it gets BOSSY! A-r says ar, like star. O-r says or, like corn. The r changes the vowel sound!",
        patterns: [
          { g: 'ar', say: 'ar', ex: 'star' },
          { g: 'or', say: 'or', ex: 'corn' }
        ],
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Bun',
      teach: {
        intro: "Here's a secret: e-r, i-r, and u-r ALL make the SAME sound — er! Her, bird, and purr all rhyme in the middle. Mimi purrs: purrrr!",
        patterns: [
          { g: 'er', say: 'er', ex: 'her' },
          { g: 'ir', say: 'er', ex: 'bird' },
          { g: 'ur', say: 'er', ex: 'purr' }
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Pip',
      teach: {
        intro: "Vowel teams are best friends who hold hands and make ONE sound! A-i says ay in the middle of words, like rain. A-y says ay at the END, like play!",
        patterns: [
          { g: 'ai', say: 'ay', ex: 'rain' },
          { g: 'ay', say: 'ay', ex: 'play' }
        ],
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Mimi',
      teach: {
        intro: "These teams all say ee! Double e like bee, e-a like leaf, and e-y like key. Three ways to spell the same happy sound!",
        patterns: [
          { g: 'ee', say: 'ee', ex: 'bee' },
          { g: 'ea', say: 'ee', ex: 'leaf' },
          { g: 'ey', say: 'ee', ex: 'key' }
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Dot',
      teach: {
        intro: "More teams! O-a says oh like boat. O-w can say oh like snow. I-g-h says eye like night — the g and h are silent ninjas! And y at the end can say eye, like fly!",
        patterns: [
          { g: 'oa', say: 'oh', ex: 'boat' },
          { g: 'ow', say: 'oh', ex: 'snow' },
      ...
      buildIt: [
        ...
        { word: 'glow', tiles: ['g', 'l', 'ow'], extra: ['oa', 't'] },
    ...
    // ─────────────────────────────────────────────
    {
      ...
      guide: 'Bun',
      teach: {
        intro: "These sounds WIGGLE in your mouth! O-u and o-w say ow like cow — ouch! O-i and o-y say oy like coin and toy! And o-o can say oo like moon, or oo like book.",
        patterns: [
      ...
      buildIt: [
        ...
        { word: 'owl', tiles: ['ow', 'l'], extra: ['ou', 't'] },
